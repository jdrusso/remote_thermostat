...
This is a pure-python (non-micropython) port of the other file.
...
class Thermostat:
    ...
    def __init__(self, temp_select_pin, temp_control_pin, fan_pin):
        ...
        self.temp_select_pin = GPIO.setup(temp_select_pin, GPIO.OUT)
        self.temp_control_pin = GPIO.setup(temp_control_pin, GPIO.OUT)
        self.fan_pin = GPIO.setup(fan_pin, GPIO.OUT)
